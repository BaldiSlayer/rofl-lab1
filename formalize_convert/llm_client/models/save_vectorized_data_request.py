...
class SaveVectorizedDataRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["data", "embeddings", "filename"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [QuestionAnswer.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
