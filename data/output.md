...
**Ответ:** Строку также часто называют словом. Гомоморфизм строк — это такая функция на множестве строк, которая подставляет определенную строку вместо каждого символа данной строки.
